defmodule PhoenixParsingMarketDataWeb.CoreComponents do
  @moduledoc """
  ...
  def simple_form(assigns) do
    ...
    <.form :let={f} for={@for} as={@as} {@rest}>
      <div class="space-y-8 bg-blue-100 mt-10">
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PhoenixParsingMarketDataWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PhoenixParsingMarketDataWeb.Gettext, "errors", msg, opts)
    end
  end
